...
class UserController extends AbstractController
{
   private $encoder ;
    ...
    {
        return $this->render('secondsite/user/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $pwa = $this->encoder->encodePassword($user, $user->getPassword());
        ...
        return $this->render('secondsite/user/new.html.twig', [
            'user' => $user,
